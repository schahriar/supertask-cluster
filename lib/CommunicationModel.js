    ...
    if(message.ticket && !message.type) {
        ...
        if(message.subtype === 'get') {
            ...
            if((message.partition.start !== undefined) && (message.partition.end !== undefined)) {
                this.buffer(id, message.storeAs || message.name, BufferObject.get(message.partition.start, message.partition.end - message.partition.start), BufferObject.encoding, !BufferObject.immutable, null, callback);
            }else{
